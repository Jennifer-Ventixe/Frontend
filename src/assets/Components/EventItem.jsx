...
import EventPicture from '/Images/EventPicture.jpg'
       ...
       <div className="event-card">
           <img src="/Images/EventPicture.jpg" alt="Konfetti" className="event-image" />
            <div className="event-date-wrapper">
              ...
              <p>{new Date(item.eventDate).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
              </p>
            </div>
           <h1 className="event-title">{item.title}</h1>
            ...
            <p className="event-price">{item.currency}{item.price}</p>
        </div>
    </Link>
